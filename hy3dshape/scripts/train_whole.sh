...
OUTPUT_DIR="/opt/liblibai-models/user-workspace/colabrate/wenda/models/trained/DiFa/hunyuan3Ddit-highpoly/whole_bs=${BS}_latents=${NUM_LATENTS}"
NUM_NODES=1
...
CKPT_PATH="/opt/liblibai-models/user-workspace/colabrate/wenda/models/trained/DiFa/hunyuan3Ddit-highpoly/whole_bs=2_latents=512/ckpt/ckpt-step=00008000.ckpt/ckpt-step=00008000.fp32" # 转换后的checkpoint
